...
class DefaultPostProcessing(PostProcessingInterface):
    ...
    def process_results(self) -> Dict:
        ...
        glob_mapping = self._settings.global_settings
        technologies = self._settings.technologies
        ...
        year_slice = DefaultPostProcessing.year_slice_index(years, time_fraction)
