    ...
    def __get_energy_prod_differences(self):
        ...
        for reg in self.model_data.settings.regions:
            ...
            for tech_type in self.model_data.settings.technologies[reg].keys():
                ...
                # compute the difference between the energy production in each timestep and the the production in the previouos
                # timestep
        ...
        return energy_prod_differences
    ...
    def rules(self):
        ...
        for reg in self.model_data.settings.regions:
            for tech_type in self.model_data.settings.technologies[reg].keys():
                ...
                max_ramp_in_timestep = self.variables.totalcapacity[reg][tech_type] * max_percentage_ramps
                min_ramp_in_timestep = self.variables.totalcapacity[reg][tech_type] * min_percentage_ramps
